      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-3 relative">
        ...
        <div className="flex items-center gap-4 z-10">
          ...
          <button
            ...
            onClick={() => router.push('/customer/dashboard/notifications')}
            ...
            >
              {userImage ? (
                <div className="relative w-10 h-10 rounded-full overflow-hidden border-2 border-purple-700 group-hover:border-purple-900 transition">
                  <Image src={userImage} alt="user Profile" fill className="object-cover" sizes="40px"/>
                </div>
              ) : (
            ...
            {menuOpen && (
              <div className="absolute right-0 mt-2 w-48 rounded-lg shadow-lg ring-1 ring-black/5 bg-white/90 backdrop-blur-sm border border-purple-100">
                ...
                <ul className="py-1 text-sm">
                  <li>
                    <button onClick={() => { setMenuOpen(false); handleNavigation("profile"); }} className="w-full text-left px-4 py-2 hover:bg-purple-50 text-purple-700">
                      Profile
                    </button>
                  </li>
                  <li>
                    <button onClick={() => { setMenuOpen(false); router.push("/customer/profile/settings"); }} className="w-full text-left px-4 py-2 hover:bg-purple-50 text-purple-700">
                      Settings
                    </button>
                  </li>
                </ul>
