...
const ASSIGNEE_SUGGESTIONS = ["Bride", "Groom", "Planner", "Photographer", "Best Man", "Maid of Honor"];
                ...
                <div className="space-y-4">
                    {filteredTasks.map((task) => {
                        ...
                        return (
                            <div
                                key={task.id}
                                className="border border-purple-300 rounded-xl p-6"
                                style={{ borderImage: "linear-gradient(to right, #622444, #ec4899) 1" }}
                            >
                                {/* Task header */}
